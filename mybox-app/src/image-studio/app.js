...
export function createImageStudioApp({ generator = null, recordStore = null } = {}) {
  ...
  const definition = {
    manifest: {
      schemaVersion: APP_SCHEMA_VERSION, id: "image-studio", name: "Image", version: "0.7.0", hostCapabilities: ["app-storage", "workflows", "connections", "resources", "codex-image-generation"],
      operations: [
