...
- Source visual truth: locally generated design reference image (not committed).
- Browser-rendered implementation: `mybox-app/implementation-final-1440.png`
- Side-by-side comparison: `mybox-app/design-comparison.png`
- Responsive capture: `mybox-app/implementation-mobile-375.png`
...
- Earlier evidence: `mybox-app/implementation-full-1440.png`.
...
- Post-fix evidence: `mybox-app/implementation-final-1440.png` and `mybox-app/design-comparison.png`.
