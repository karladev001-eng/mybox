...
Contains first-party static media referenced by the UI. Inspect individual binary
...
- `mybox-wordmark.png`: mark plus wordmark in the same light ink, for surfaces
  that need the full lockup.
